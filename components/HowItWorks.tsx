            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-20 section-reveal">
                    <h2 className="text-4xl md:text-6xl font-bold mb-6">
                        Cómo Funciona el Sistema: <br /> El <span className="gradient-text">Flujo Magnético del Dinero</span>
                    </h2>
                </div>
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="text-center section-reveal">
                        ...
                        <h3 className="text-2xl font-bold mb-4">GENERACIÓN DE PROSPECTOS</h3>
                        <p className="text-gray-400">Una vez que el sistema arranca, los prospectos comienzan a fluir automáticamente a tus DMs. Aprende a configurarlo con anuncios pagados y tráfico orgánico usando IA.</p>
                    </div>
                    <div className="text-center section-reveal" style={{ transitionDelay: '0.2s' }}>
                        ...
                        <h3 className="text-2xl font-bold mb-4">NUTRICIÓN AUTOMATIZADA</h3>
                 ...
                 <div className="text-center glass p-10 rounded-3xl mt-24 section-reveal">
                    <h3 className="text-2xl font-bold mb-4 gradient-text">RESULTADOS ESPERADOS PARA CLIENTES</h3>
